...
3. "MILD_COMPLAINT": Tin nhắn phàn nàn nhẹ nhàng, báo lỗi dịch vụ, than phiền vì dịch vụ chậm, thái độ lo lắng hoặc thắc mắc về chất lượng.
4. "NORMAL": Tin nhắn bình thường, hỏi mua hàng, trò chuyện vui vẻ, hoặc không có ý định xấu.
  ...
  try {
    const response = await ai.models.generateContent({
      ...
      config: {
        ...
        temperature: 0.1, // Nhiệt độ thấp để AI phân loại chính xác, ít ảo giác
      }
    });
